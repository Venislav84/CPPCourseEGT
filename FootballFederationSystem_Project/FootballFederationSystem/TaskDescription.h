...
//
//Администрация :
//-Добавя, променя и отписва отбори.Информацията за отбора  е : 
//име, адрес, град, треньор, играчи, изиграни срещи, победи, задгуби, равенства, точки и класиране(за година), снимка
...
//брой зрители за отборите по срещи, картони и други.Статистиката се вижда от всички потребители.